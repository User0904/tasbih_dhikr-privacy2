...
This privacy notice for Yuzult ("we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:
Download and use our mobile application (Tasbih Dhikr), or any other application of ours that links to this privacy notice
...
1. Education Information	Student records and directory information	NO
J. Inferences drawn from	Inferences drawn from any of the collected personal information listed above to create a
collected personal information profile or summary about, for example, an
individual's preferences and characteristics	NO
